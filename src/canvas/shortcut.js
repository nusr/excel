...
export function computeScrollRowAndCol(controller, left, top) {
...
export function computeScrollPosition(controller, left, top) {
...
export function scrollBar(controller, scrollX, scrollY) {
    const oldScroll = controller.getScroll();
...
export const keyboardEventList = [
    {
        key: 'Enter',
        modifierKey: [],
        handler: (controller) => {
