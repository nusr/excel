...
export type TextFormulaKeys = 'CONCATENATE' | 'CONCAT' | 'SPLIT' | 'T' | 'LOWER' | 'CHAR' | 'CODE' | 'LEN' | 'UNICHAR' | 'UNICODE' | 'UPPER' | 'TRIM';
export type MathFormulaKeys = 'ABS' | 'ACOS' | 'ACOSH' | 'ACOT' | 'ACOTH' | 'ASIN' | 'ASINH' | 'ATAN' | 'ATAN2' | 'ATANH' | 'COS' | 'COT' | 'COS' | 'EXP' | 'INT' | 'PI' | 'E' | 'SIN' | 'SUM';
