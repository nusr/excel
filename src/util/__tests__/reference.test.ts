...
describe.only("reference.test.ts", () => {
  ...
  describe("parseCell", () => {
    ...
    it("should convert A to { row:0,col:0,rowCount:30,colCount: 0 } ", function () {
    ...
    it("should convert Sheet1!A to { row:0,col:0,rowCount:30,colCount: 0, sheetId: Sheet1 } ", function () {
      expect(parseCell("Sheet1!A")).toEqual(new Range(0, 0, 30, 0, "Sheet1"));
    });
