...
export function makeFont(fontStyle = 'normal', fontWeight = 'normal', fontSize = 12, fontFamily = '') {
...
export function convertCanvasStyleToString(style) {
    let result = '';
    if (style.fontColor) {
...
export function parseStyle(styleList, selector) {
