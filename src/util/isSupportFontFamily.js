...
function SupportFontFamilyFactory(body = document.body) {
    ...
    const isSupportFontFamily = function (fontFamily) {
        return (monoWidth !== getWidth(`${fontFamily},${monoFont}`) ||
...
export function initFontFamilyList(fontList = FONT_FAMILY_LIST) {
    ...
    if (cacheFont) {
        const fontList = JSON.parse(cacheFont);
...
//# sourceMappingURL=isSupportFontFamily.js.map