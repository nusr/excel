...
export function parseCell(ref, convertSheetName = convertSheetNameToSheetId) {
...
export function parseReference(text, convertSheetName = convertSheetNameToSheetId) {
...
export function mergeRange(start, end) {
