...
import { DEFAULT_FONT_SIZE, DEFAULT_FONT_COLOR, copy, cut, paste, } from '@/util';
...
const handleStateChange = (changeSet, controller) => {
    if (changeSet.has('setActiveCell') ||
        ...
        const { isBold = false, isItalic = false, fontSize = DEFAULT_FONT_SIZE, fontColor = DEFAULT_FONT_COLOR, fillColor = '', isWrapText = false, underline = EUnderLine.NONE, fontFamily = '', numberFormat = 0, } = cell.style;
